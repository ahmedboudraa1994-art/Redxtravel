...
const I18N = {
  fr: {
    ...
    seeOffers:"Découvrir les offres",
    quoteBtn:"Demander un devis",
    hotels:"Séjours & hôtels",
    hotelsSub:"Des adresses choisies selon votre budget",
    flights:"Billets d’avion",
    flightsSub:"Aller simple, retour et itinéraires flexibles",
    packs:"Voyages sur mesure",
    packsSub:"Des programmes adaptés à chaque client",
    currentOffers:"OFFRES ACTUELLES",
    offersHeading:"Des offres lisibles, prêtes à comparer.",
    ...
    requestTitle:"Recevez une proposition adaptée.",
  ...
  en: {
    ...
    seeOffers:"Explore offers",
    quoteBtn:"Request a quote",
    hotels:"Stays & hotels",
    hotelsSub:"Selected options for every budget",
    flights:"Flight tickets",
    flightsSub:"One-way, return and flexible routes",
    packs:"Tailor-made trips",
    packsSub:"Travel plans built around each client",
    currentOffers:"CURRENT OFFERS",
    offersHeading:"Clear offers, easy to compare.",
    ...
    requestTitle:"Receive a tailored proposal.",
  ...
  ar: {
    ...
    seeOffers:"استعرض العروض",
    quoteBtn:"اطلب عرض سعر",
    hotels:"إقامات وفنادق",
    hotelsSub:"خيارات مناسبة لمختلف الميزانيات",
    flights:"تذاكر الطيران",
    flightsSub:"ذهاب فقط، ذهاب وعودة ومسارات مرنة",
    packs:"رحلات حسب الطلب",
    packsSub:"برامج سفر مصممة حسب احتياج كل عميل",
    currentOffers:"العروض الحالية",
    offersHeading:"عروض واضحة وسهلة المقارنة.",
    offersText:"كل صورة تتضمن أهم تفاصيل العرض. يمكن للعميل التصفح، المقارنة، ثم إرسال طلبه خلال ثوانٍ.",
    requestLabel:"طلب مخصّص",
    requestTitle:"احصل على اقتراح يناسب رحلتك.",
