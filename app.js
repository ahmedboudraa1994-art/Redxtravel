...
const I18N = {
  fr: {
    ...
    heroTitle:"Des voyages mieux pensés, des offres plus claires.",
    heroSubtitle:"Découvrez les meilleures offres publiées par l’agence, puis envoyez une demande personnalisée selon votre destination, vos dates et votre budget.",
    seeOffers:"Voir les offres",
    quoteBtn:"Demander un devis",
    hotels:"Hôtels",
    hotelsSub:"Séjours, demi-pension, all inclusive",
    flights:"Vols",
    flightsSub:"Aller simple, retour, multi-vols",
    packs:"Packs",
    packsSub:"Voyages organisés et sur mesure",
    currentOffers:"OFFRES ACTUELLES",
    offersHeading:"Affiches claires, navigation fluide.",
    offersText:"Les photos contiennent déjà les détails de chaque offre. Le client peut faire défiler, comparer, puis descendre au formulaire.",
  ...
  en: {
    ...
    heroTitle:"Smarter trips, clearer offers.",
    heroSubtitle:"Explore the latest offers published by the agency, then send a personalized request based on your destination, dates and budget.",
    seeOffers:"View offers",
    quoteBtn:"Request a quote",
    hotels:"Hotels",
    hotelsSub:"Stays, half board, all inclusive",
    flights:"Flights",
    flightsSub:"One-way, return, multi-city",
    packs:"Packages",
    packsSub:"Organized and tailor-made trips",
    currentOffers:"CURRENT OFFERS",
    offersHeading:"Clear posters, smooth browsing.",
    offersText:"Each poster already includes the key offer details. Clients can swipe, compare, then continue to the request form.",
    requestLabel:"Personalized request",
  ...
  ar: {
    ...
    heroTitle:"رحلات مدروسة وعروض واضحة.",
    heroSubtitle:"تصفّح أحدث العروض المنشورة من الوكالة، ثم أرسل طلبًا مخصّصًا حسب وجهتك، تواريخ سفرك وميزانيتك.",
    seeOffers:"عرض العروض",
    quoteBtn:"طلب عرض سعر",
    hotels:"فنادق",
    hotelsSub:"إقامات، نصف إقامة، شامل كليًا",
    flights:"تذاكر طيران",
    flightsSub:"ذهاب فقط، ذهاب وعودة، رحلات متعددة",
    packs:"باقات سفر",
    packsSub:"رحلات منظّمة وبرامج حسب الطلب",
    currentOffers:"العروض الحالية",
    offersHeading:"عروض واضحة وتصفّح سلس.",
    offersText:"تحتوي كل صورة على تفاصيل العرض الأساسية. يمكن للعميل التمرير، المقارنة، ثم الانتقال إلى نموذج الطلب.",
